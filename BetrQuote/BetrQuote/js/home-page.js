...
//         jQuery(input).closest('.form-input-c-main').find('.error-message').text(message).show(); // Adjusted to find the error message span
//     }

//     // Function to hide error messages
//     function hideError(input) {
//         jQuery(input).closest('.form-input-c-main').find('.error-message').hide(); // Adjusted to find the error message span
//     }
...
// 				showError('.fieldset-inner-box', 'Please select a project type.'); // Adjust the selector as needed
// 				isValid = false;
// 			}
// 		}
...
// 		// if (current === 3) {
// 		// 	var address = $('#address').val().trim(); // Use ID instead of placeholder
// 		// 	if (!address) {
// 		// 		showError('#address', 'Please enter your street address.'); // Show error message
// 		// 		isValid = false;
// 		// 	}
// 		// }
...
// 		if (current === 4) {
// 			var email = jQuery('#email').val().trim(); // Use ID instead of placeholder
...
// 			if (!firstName) {
// 				showError('#first_name', 'Please enter your first name.'); // Show error message
// 				isValid = false;
// 			}
// 			if (!lastName) {
