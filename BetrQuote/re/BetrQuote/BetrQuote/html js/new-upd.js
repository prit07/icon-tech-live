jQuery(document).ready(function () {
    ...
    function validateCurrentStep() {
        ...
        if (current === 7) {
            var gutterMaterial1 = jQuery('#gutter_material1').val();
            if (!gutterMaterial1) {
                showError('#gutter_material1', 'Please select a gutter material.');
                isValid = false;
            }
        }
        ...
        if (current === 8) {
            var gutterMaterial2 = jQuery('#gutter_material2').val();
            if (!gutterMaterial2) {
                showError('#gutter_material2', 'Please select an option for home owner.');
                isValid = false;
            }
        }
    
        if (current === 9) {
            var gutterMaterial3 = jQuery('#gutter_material3').val();
            if (!gutterMaterial3) {
                showError('#gutter_material2', 'Please select an option for home owner.');
                isValid = false;
            }
    ...
    btnnext.click(function () {
        ...
        if (validateCurrentStep()) {
            if (current < widget.length) {
                ...
                if (current === 7) {
                    // Recheck if a valid option is selected in the dropdown for step 1
                    var gutterMaterial1 = jQuery('#gutter_material1').val();
    ...
    //     }
    // });
    jQuery('#gutter_material1, #gutter_material2 , #gutter_material3 , #fieldset_box1 , #fieldset_box2 , #fieldset_box3 , #fieldset_box4 ,#fieldset_box5').change(function () {
