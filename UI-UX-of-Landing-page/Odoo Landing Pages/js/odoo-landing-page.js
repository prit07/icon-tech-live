jQuery(document).ready(function () {
    ...
    // Our Odoo Products tabing Start

    $('.products-tab-a').click(function () {
        $(".products-tab").removeClass('products-tab-active');
        $(".products-tab[data-id='" + $(this).attr('data-id') + "']").addClass("products-tab-active");

        // Remove the active class from all <li> elements
        $(".products-tab-menu li").removeClass('products-active-a');

        // Add the active class to the parent <li> of the clicked <a>
        $(this).parent("li").addClass('products-active-a');
    });


    
	$('.services-tab-a').click(function(){  
		$(".services-tab").removeClass('services-tab-active');
		$(".services-tab[data-id='"+$(this).attr('data-id')+"']").addClass("services-tab-active");
		$(".services-tab-a").removeClass('services-active-a');
		$(this).parent().find(".services-tab-a").addClass('services-active-a');
	});
});