...
function submitForm() {
  ...
  if (userInput.length >= 3) {
    ...
    showUserValue2.innerHTML = 'User Id :  <span style="color:green; font-weight: bold;"  class="fade-in">  ' +  userInput + '</span>' ;
...
function ResourceSelected(id, value) {
  ...
  allResourceElements.forEach(function (element) { element.classList.remove('Selected'); });
...
function GenerateButton() {
  ...
  if (selectedValue1 !== '' && selectedValue2 !== "") {
    ...
    selectedValueElement.innerHTML = 'Gold : <span style="color:green; font-weight: bold;"  class="fade-in" > ' + selectedValue + '</span>';
    selectedValueElement1.innerHTML = 'Gems : <span style="color:green; font-weight: bold;"  class="fade-in" > ' + selectedValue2 + '</span>';
    selectedValueElement2.innerHTML = 'Platform :  <span style="color:green; font-weight: bold;"  class="fade-in">  '  +  startSecondSearchValue  + '</span>';
    ...
    setTimeout(function () {
      ...
      selectedValueElement.textContent = (' Adding Generated Gold and Gems. ');
    }, 17000)
    setTimeout(function () {
      var selectedValueElement = document.getElementById('selectedValue1');
      selectedValueElement.innerHTML = ' Gems Load successful  <span style="color:green; font-weight: bold;"  class="fade-in">  ' + selectedValue2 + '</span>';
    }, 15000)
    setTimeout(function () {
      var selectedValueElement = document.getElementById('selectedValue1');
    ...
    setTimeout(function () {
      var selectedValueElement = document.getElementById('selectedValue1');
      selectedValueElement.innerHTML = ' Gold Load successful  <span style="color:green;  font-weight: bold;  " class="fade-in"> ' + selectedValue1 + '</span>';
    }, 11000)
    setTimeout(function () {
      var selectedValueElement = document.getElementById('selectedValue1');
    ...
    setTimeout(function () {
      var selectedValueElement = document.getElementById('selectedValue1');
      selectedValueElement.innerHTML = ('<span class="bounce-In"> Connecting to Gummy Drop! Match 3  Server... </span>');
    }, 2000)
    setTimeout(function () {
      var selectedValueElement = document.getElementById('selectedValue1');
